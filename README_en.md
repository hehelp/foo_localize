...
Component version: `1.5.0`. 中文：[README.md](README.md).
...
1. Open **[Releases](https://github.com/hehelp/foo_localize/releases)** and download `foo_localize-1.5.0.fb2k-component` (official foobar package: one zip with 32-bit, 64-bit, and macOS; Install picks the matching binary).
